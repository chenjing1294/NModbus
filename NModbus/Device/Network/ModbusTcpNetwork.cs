...
namespace NModbus.Device.Network
{
    ...
    /// Modbus TCP 服务器端
    /// </summary>
    public class ModbusTcpNetwork : ModbusNetwork
    {
        private const int TimeWaitResponse = 1000;
        private readonly object _serverLock = new object();

        private readonly ConcurrentDictionary<string, ModbusMasterTcpConnection> _masters = new ConcurrentDictionary<string, ModbusMasterTcpConnection>();

        private TcpListener _server;

        public ModbusTcpNetwork(TcpListener tcpListener, IModbusFactory modbusFactory, IModbusLogger logger)
